...
class SecretProvider(ABC):
    """Every secret backend (this app's own Postgres database,Infisical, AWS Secrets
    ...
    provider maps it to its own native namespacing concept (a Postgres/Infisical/AWS/Vault
