...
export const endpoints = {
  ...
  getAgentCatalog: () => api.get("/v1/agents/catalog"),
  ...
  getAgentAuditLog: (id, params) => api.get(`/v1/agents/${id}/audit-log`, { params }),
  getAgentStats: (id) => api.get(`/v1/agents/${id}/stats`),
  getAgentPricing: (id) => api.get(`/v1/agents/${id}/pricing`),
  setAgentPricing: (id, data) => api.put(`/v1/agents/${id}/pricing`, data),
  healthCheckAgent: (id) => api.post(`/v1/agents/${id}/health-check`),
  enableAgentForProject: (id, data) => api.post(`/v1/agents/${id}/enable-project`, data),
  disableAgentForProject: (id, data) => api.post(`/v1/agents/${id}/disable-project`, data),
  ...
  assignApprovalReviewer: (taskId, data) => api.post(`/v1/agent-approvals/${taskId}/assign-reviewer`, data),
  addApprovalEvidence: (taskId, data) => api.patch(`/v1/agent-approvals/${taskId}/evidence`, data),
  listApprovalComments: (taskId) => api.get(`/v1/agent-approvals/${taskId}/comments`),
  addApprovalComment: (taskId, data) => api.post(`/v1/agent-approvals/${taskId}/comments`, data),
